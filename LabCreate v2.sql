...
CREATE TABLE POMIAR (
    ...
    TYP_POMIAR varchar(20) NOT NULL,
    WARTOSC_NUM decimal(9,3) NULL,
    WARTOSC_BOOL bool NULL,
    WARTOSC_STR varchar(100) NULL,
    WARTOSC_ENUM varchar(50) NULL,
...
CREATE TABLE PROBA (
    ...
    NR_SERII varchar(20) NOT NULL,
    SPECYFIKACJA_ID_SPECYFIKACJI bigint NULL,
    NR_SERII_WYTWORCY varchar(20) NULL,
    DOSTAWCA_ID_DOSTAWCA bigint NULL,
    ETAP_PROD_ID_ETAP_PROD bigint NULL,
    TYP_PROBY_ID_TYP_PROBY bigint NULL,
...
CREATE TABLE WYNIK (
    ...
    DATA_SPRAWDZENIA timestamp NULL,
    PRACOWNIK_ID_PRACOWNIKA bigint NULL,
    JEDN_MIARY_ID_JEDN_MIARY bigint NULL,
    URZADZENIE_ID_URZADZENIA bigint NULL,
