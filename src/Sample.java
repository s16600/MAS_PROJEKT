...
public /*abstract*/ class Sample extends MyExtension {
	...
	public String toString() {
		...
		try {
			text = "Sample: "  + nrProby + ", " + nrSerii;
			//text = "Sample: " + nrProby + ", " + nrSerii + ", evaluated by: " + this.getLinks("evaluatedBy")[0] +"\n";
			//for (MyExtension r : this.getLinks("result")) text += " - " + r.toString() +"\n";
		} catch (Exception e) {
	...
	public Sample(int idSample, String nrProby, String nrSerii, String nazwaProby, Date dataPoboru, Date dataProdukcji, Date dataWaznosci, Date dataOceny, 
